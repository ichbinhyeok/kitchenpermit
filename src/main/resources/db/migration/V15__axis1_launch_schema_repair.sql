...
create table if not exists axis1_company_profiles (
    id uuid primary key,
...
create table if not exists axis1_report_records (
    id uuid primary key,
...
create index if not exists idx_axis1_report_records_account_email
    on axis1_report_records(account_email);

create index if not exists idx_axis1_report_records_next_service_date
