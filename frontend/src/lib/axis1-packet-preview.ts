...
const baseProofPhotos = [
  ...
  },
  {
    ...
    caption: "Filters are shown removed and staged as part of the documented service flow.",
  ...
  },
  {
    ...
    systemRef: "DK-02",
    label: "Access",
    title: "Duct access work",
    caption: "Active access work is shown when interior duct service is performed.",
  ...
  },
  {
    ...
    caption: "Visible exhaust fan area is tied back to the customer record.",
  ...
  },
  {
    ...
    systemRef: "GC-01",
    label: "Record",
    title: "Grease removed",
    caption: "Removed buildup is recorded as proof of work, not just claimed.",
...
export function getAxis1PacketPreviewData(options: {
  ...
  return {
    ...
    systemIdentityRows: [
      ...
      ["Access basis", "Accessible hood, filters, plenum, duct path, and fan area"],
    ...
    routeSegments: [
      ...
      },
      {
        ...
        title: "Filter bank",
        status: "Reset",
        note: "Removed, cleaned, inspected, reinstalled",
      },
      {
        code: "PL-01",
        title: "Plenum / duct path",
        status: "Reachable cleaned",
        note: "Reachable path cleaned and documented in packet scope",
      },
      {
        code: "DK-02",
      ...
      {
        code: "RF-01",
        title: "Rooftop fan / hinge line",
        status: "Review",
        note: "Visible hinge, curb, and fan-adjacent condition recorded for follow-up",
      },
      {
        code: "GC-01",
        title: "Grease containment path",
        status: "Documented",
        note: "Visible containment and drip-path condition recorded for customer file",
      },
    ],
    ...
    componentStatusRows: [
      ...
      {
        component: "Baffle filter bank",
        status: "Removed + reset",
        proof: "P-03",
        note: "Filters removed, cleaned, inspected, and reinstalled.",
      },
      {
      ...
      {
        component: "Rooftop fan / hinge line",
        status: "Review",
        proof: "P-05",
        note: "Hinge and curb-line condition recorded for repair review.",
      },
      {
        component: "Grease containment path",
        status: "Documented",
        proof: "P-06",
        note: "Drip path and removed buildup recorded for customer file.",
      },
    ],
    photoCoverageRows: [
      { item: "Before hood interior", proof: "P-01", status: "Included" },
      { item: "After hood interior", proof: "P-02", status: "Included" },
      { item: "Filter bank reset", proof: "P-03", status: "Included" },
      {
        item: "Access condition",
        proof: "P-04",
        status: exceptionOpen ? "Exception shown" : "Included",
      },
      { item: "Rooftop fan area", proof: "P-05", status: "Included" },
      { item: "Grease removed / containment", proof: "P-06", status: "Included" },
      {
    ...
    scopeRows: [
      ...
      ["FL-01 Filter bank", "Reset", "Removed, cleaned, inspected, reinstalled"],
      ...
      ["RF-01 Rooftop fan hinge / curb line", "Review", "Condition recorded for repair review or next-cycle monitoring"],
      ["GC-01 Grease containment", "Documented", "Drip path and containment condition recorded for customer file"],
    ],
    completedWork: [
      ...
      "Recorded rooftop fan, hinge, curb, and grease-containment condition for future follow-up",
      "Posted service label and exception notice at close-out",
      "Prepared a same-day customer service report with next-step guidance",
    ],
    operationalChecks: [
      ...
      ["Rooftop fan visually documented", "Documented"],
      ["Grease containment / drip area reviewed", "Reviewed"],
    ...
    deficiencyRows: exceptionOpen
      ? [
          ...
          },
          {
            ...
            issue: "Wear is visible at the rooftop fan hinge and curb line during the record capture.",
            whyItMatters:
          ...
          {
            location: "GC-01 Grease containment / drip path",
            issue: "Visible staining is present near the grease containment path.",
            whyItMatters:
